                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <button type="button" class="btn-action shadow-sm" 
                                    ...
                                    <form action="{{ url('/she/master/pb/destroy/' . $pb->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
            ...
            <form action="{{ url('/she/master/pb/store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea name="nama_pb" id="nama_pb" class="form-control bg-light border-0" rows="4" required placeholder="Contoh: Pencahayaan kurang di lorong gudang A..."></textarea>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered"> 
        <div class="modal-content shadow-2xl">
            ...
            <form action="{{ url('/she/master/pb/update/' . $pb->id) }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="edit_nama_pb{{ $pb->id }}" class="form-label fw-bold text-dark">Deskripsi Potensi Bahaya</label>
                        <textarea name="nama_pb" id="edit_nama_pb{{ $pb->id }}" class="form-control bg-light border-0" rows="4" required>{{ $pb->nama_pb }}</textarea>
                    </div>
                </div>
                <div class="modal-footer d-flex gap-2">
                    <button type="button" class="btn btn-light flex-grow-1" data-bs-dismiss="modal">Batal</button>
