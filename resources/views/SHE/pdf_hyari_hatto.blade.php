...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Tgl Berlaku : {{ $data->created_at->format('Y-m-d') }}</td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td colspan="2" class="bg-gray">I. KONDISI TEMUAN</td>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            <td colspan="4" class="bg-gray">II. POTENSI BAHAYA</td>
        </tr>
        ...
        <tr>
            <td width="35%" style="text-align: center; vertical-align: middle; padding: 10px; height: 180px;">
                @php
                    ...
                    if ($data->bukti) {
                        $possiblePaths = [
                            public_path('storage/' . $data->bukti),
                            storage_path('app/public/' . $data->bukti),
                            public_path($data->bukti)
                        ];
                ...
                @if($imagePath)
                    <img src="{{ $imagePath }}" style="width: 180px; max-height: 160px; border: 1px solid #000;">
                @else
    ...
    <table>
        <tr>
            <td class="bg-gray">IV. USULAN COUNTERMEASURE</td>
        </tr>
        <tr>
            <td height="40px">{{ $data->usulan ?? '-' }}</td>
        </tr>
        <tr>
            <td class="bg-gray">V. REKOMENDASI P2K3</td>
        </tr>
        <tr>
            <td height="50px">{{ $data->rekomendasi ?? '' }}</td>
        </tr>
    </table>
