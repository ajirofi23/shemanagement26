...
<div class="content p-4 page-entry">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        ...
        <button type="button" class="btn btn-primary btn-modern shadow-sm" data-bs-toggle="modal" data-bs-target="#addPfModal">
        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 col-md-8">
                    <form action="{{ url('/she/master/pf') }}" method="GET">
                        <div class="search-container d-flex align-items-center">
                            ...
                            <input type="text" id="searchInput" name="search" value="{{ request('search') }}" class="form-control" placeholder="">
                ...
                <div class="col-12 col-md-4 text-md-end d-flex align-items-center justify-content-md-end">
                    <a href="{{ url('/she/master/pf/export') }}" class="btn btn-outline-success btn-modern w-100 w-md-auto">
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary border-0" 
                                        ...
                                        data-bs-target="#editPfModal{{ $pf->id }}"
                                    ...
                                    <form action="{{ url('/she/master/pf/destroy/' . $pf->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
<style>
    ...
    .custom-input:focus { box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1); border-color: #2563eb; }
</style>
    ...
    <div class="modal-dialog modal-dialog-centered"> 
        <div class="modal-content shadow-lg">
            <div class="modal-header">
                <h5 class="modal-title fw-bold"><i class="bi bi-plus-circle-fill text-primary me-2"></i> Tambah Pelanggaran Fisik</h5>
            ...
            <div class="modal-body">
                <form action="{{ url('/she/master/pf/store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="nama_pf" class="form-label fw-bold small">Nama Pelanggaran Fisik <span class="text-danger">*</span></label>
                        <textarea name="nama_pf" id="nama_pf" class="form-control custom-input" rows="4" required placeholder="Masukkan keterangan pelanggaran..."></textarea>
                        <small class="form-text text-muted">Contoh: Deskripsi kesalahan fisik dokumen atau personil.</small>
                    </div>
                    
                    <div class="modal-footer px-0 pb-0 mt-3 d-flex gap-2">
                        <button type="button" class="btn btn-light btn-modern flex-grow-1" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-primary btn-modern flex-grow-2"><i class="bi bi-save me-1"></i> Simpan Data</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content shadow-lg">
            ...
            <div class="modal-body">
                <form action="{{ url('/she/master/pf/update/' . $pf->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="edit_nama_pf{{ $pf->id }}" class="form-label fw-bold small">Nama Pelanggaran Fisik <span class="text-danger">*</span></label>
                        <textarea name="nama_pf" id="edit_nama_pf{{ $pf->id }}" class="form-control custom-input" rows="4" required>{{ $pf->nama_pf }}</textarea>
                    </div>
                    
                    <div class="modal-footer px-0 pb-0 mt-3 d-flex gap-2">
                        <button type="button" class="btn btn-light btn-modern flex-grow-1" data-bs-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-primary btn-modern flex-grow-2"><i class="bi bi-check-circle me-1"></i> Update Perubahan</button>
                    </div>
                </form>
            </div>
        </div>
