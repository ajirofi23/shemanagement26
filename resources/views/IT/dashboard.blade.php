...
<div class="content">
    <div class="d-flex justify-content-between align-items-end mb-5 animate-in">
        <div>
            <h1 class="fw-800 display-6 mb-1" style="color: var(--text-main); font-weight: 800;">Analytics Dashboard</h1>
            <p class="text-muted fw-500 mb-0">Insights and real-time user metrics</p>
        </div>
        <div class="text-end d-none d-md-block">
            <span class="badge bg-white text-dark border shadow-sm p-2 px-3 rounded-pill">
                <i class="bi bi-calendar-event me-2"></i> {{ date('D, d M Y') }}
            </span>
        </div>
    </div>
                        ...
                        <td style="width: 30%;">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="progress flex-grow-1" style="height: 6px;">
                                    <div class="progress-bar bg-primary shadow-sm" style="width: {{ $section['activePercent'] }}%"></div>
                                </div>
                            </div>
                        </td>
